cask "proxybot" do
  ...
  version "1.2.0"
  sha256 arm:   "cca8c6ffb16c653d1409f516b55154c49653ec8249f263ac632d7c01c397a695",
         intel: "TODO: compute after first release - run on Intel Mac"

  url "https://github.com/mbpz/proxybot/releases/download/v#{version}/ProxyBot-#{version}-mac-#{arch}"
  name "ProxyBot"
  ...
  artifact "ProxyBot", target: "/Applications/ProxyBot.app"
